                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="custom-file">
                                        <input type="file" required accept="image/*" name="p_img" class="custom-file-input p-Img" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <a href="<?= URLROOT . 'admin/category' ?>"><button type="button" class="btn btn-secondary">Go Back</button></a>
                                        </div>
                                    </div>
                                </div>
                        </form>
